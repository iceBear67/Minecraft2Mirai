...
public abstract class Bot {
    ...
    public static ChatGroup getGroup(String platform, long groupId){
        return AdapterMain.getPlugin(AdapterMain.class).getBot().getGroup(groupId).orElseThrow(AssertionError::new);
    }
